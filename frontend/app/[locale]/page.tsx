...
export default function Home() {
    ...
    const platformKeys = ['sora', 'veo', 'runway', 'pika', 'kling', 'hailuo', 'luma'];
            ...
            <section className="py-16 border-y border-white/5 bg-gradient-to-b from-black to-gray-950">
                <div className="container max-w-6xl mx-auto text-center px-4">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <p className="text-sm font-medium text-primary mb-3 uppercase tracking-wider">{t('Platforms.badge')}</p>
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">{t('Platforms.title')}</h3>
                        <p className="text-gray-400 mb-10 max-w-2xl mx-auto">{t('Platforms.description')}</p>
                    </motion.div>
                    <div className="flex flex-wrap justify-center gap-4">
                        {platformKeys.map((key, idx) => (
                            <motion.div
                                key={key}
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
