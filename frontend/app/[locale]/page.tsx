        ...
        <main className="min-h-screen relative overflow-hidden bg-black text-white selection:bg-primary/30">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        {aiPlatforms.map((platform, idx) => (
                            <motion.div
                                ...
                                className="group relative p-4 rounded-xl bg-white/5 border border-white/10 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
                            >
            ...
            <section className="py-32 px-4 relative z-10 bg-white/[0.02]">
                <div className="container max-w-6xl mx-auto">
                    ...
                    >
                        {[
                            { value: '50,000+', label: t('Stats.videosProcessed') },
                            { value: '10,000+', label: t('Stats.happyUsers') },
                            { value: '99.9%', label: t('Stats.successRate') },
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {['creator', 'editor', 'agency'].map((key, index) => (
                            <motion.div
                                key={key}
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                ...
                                transition={{ delay: index * 0.1 }}
                            >
                                <Card className="h-full bg-white/[0.03] border-white/10 hover:border-white/20 transition-all duration-300">
